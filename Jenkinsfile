pipeline {
    ...
    environment {
        ...
        DOCKERHUB_USERNAME = 'a4671satya'  // Set this directly to your Docker Hub username
        ...
        stage('Sonar Analysis') {
            steps {
                withSonarQubeEnv('sonar-server') {
                    sh "$SCANNER_HOME/bin/sonar-scanner -Dsonar.projectName=satya -Dsonar.projectKey=KastroKey -Dsonar.java.binaries=target"
                }
            }
        }
